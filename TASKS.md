...
- [x] Prepare migration 017; verify reset/stale mission invariants in an isolated rolled-back schema.
- [ ] Apply migration 017 to the shared environment in a coordinated release.
