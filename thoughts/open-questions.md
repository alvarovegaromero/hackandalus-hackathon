...
- [ ] **Separate ground truth from the Digital Twin in the schema.** The
      ...
      table with an origin column. Without this, _time-to-truth_ and _twin
      accuracy_ cannot be measured.
...
- [ ] **Digital Twin metrics**: _time-to-truth_, _twin accuracy_, false or
      stale state rate, uncertainty reduction after verification, _decision
      recovery time_. Decide where they are computed (the `learning` module,
